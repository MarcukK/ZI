...
namespace _8
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string initialMessageBytes = "вод";
            byte[] bytes = Encoding.GetEncoding(1251).GetBytes(initialMessageBytes);
            int integ;
            string str = "";
            ...
            str = "1001110010110000";
            Console.WriteLine("str - " + str);
            Console.WriteLine();


            string[] initMessages = new string[] { "константин", "марчук", "водоворотоподобный", str };
            ...
            foreach (string initMessage in initMessages)
            {
                ...
                Console.WriteLine("Initial Message - " + initMessage);
                Console.WriteLine();
                //Encoding
                ...
                Console.WriteLine("Getted Message - " + gettedMessage);
                Console.WriteLine();

                W2Dec = CreateDecodingMatrix(gettedMessage);
                Console.WriteLine("W2Dec");
                ShowMatrix(W2Dec);
                ...
                Console.WriteLine("Decoded Initital Message - " + W2Dec[numberOfInitialMessage]);
